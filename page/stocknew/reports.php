...
class page_stocknew_reports extends Page {
	...
	function page_overall(){
		...
		$form->addField('DropDown','status')->setValueList(['Active'=>'Active','InActive'=>'InActive'])->setEmptyText('Please Select Item Status');
		...
		if(!empty($_GET['status'])){
			...
			$item_stock->addCondition('is_active',false);
			}else{
				$item_stock->addCondition('is_active',true);
			}	
		}
