...
class page_reports_deposit_emireceivedlist extends Page {
	...
	function init(){
		...
		$mo_join=$account_join->leftJoin('mos','mo_id');
		$mo_join->addField('mo_name','name');
		...
		$grid->setModel($transaction_row_model,array('AccountNumber','member_name','phone_no','pan_no','FatherName','CurrentAddress','landmark','due_premium_count','amountCr','mo_name','agent_name','agent_account_number','created_at','Narration','scheme_name','last_paid_on'));
