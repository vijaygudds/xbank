...
class page_reports_loan_gstreceivedlist extends Page {
	...
	function init(){
		...
		$grid->setModel($transaction_row_model,array('AccountNumber','member_name','member_address','member_landmark','FatherName','PhoneNos','amountCr','Narration','created_at','dealer_name','is_in_legal','is_given_for_legal_process','memorandum_type','legal_process_given_date','legal_filing_date'));
