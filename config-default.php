...
// $config['dsn']='mysql://root:winserver@127.0.0.1/bccs';
// $config['dsn']='mysql://root:winserver@127.0.0.1/bccs2';
// $config['dsn']='mysql://root:winserver@127.0.0.1/temp';
...
define('MEMORANDUM_ACCOUNT_TRA_ARRAY',[
										...
										//GST ke policy ke other charge ke amount ko dalne ka option nhi hone se is transaction type ko add kiya gya hai
										'gst_other_charge'=>['GST OTHER CHARGE RECEIVED']
